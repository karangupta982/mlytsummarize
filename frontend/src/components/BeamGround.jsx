...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "min-h-screen w-full bg-gradient-to-b from-black to-gray-900 relative flex items-center justify-center overflow-hidden",
        className
      )}>
      {beams.map((beam) => (
        <CollisionMechanism
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 bg-black bg-opacity-20 w-full inset-x-0 pointer-events-none"
        style={{
          boxShadow:
